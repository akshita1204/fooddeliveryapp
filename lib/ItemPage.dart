  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child:ListView(
        children: [
          AppBarWidget(),
          Padding(padding: EdgeInsets.all(16),child:Image.asset("assets/images/pizza.png",
          height: 300,
...
child:Text("Taste our Hot Pizza at the lowest Price.You will definetely love it,just try it once.It'll worth buying it.Enjoy the circle of pizza with your friendcircle.Taste our Hot Pizza at the lowest Price.You will definetely love it,just try it once.It'll worth buying it.Enjoy the circle of pizza with your friendcircle.Taste our Hot Pizza at the lowest Price.You will definetely love it,just try it once.It'll worth buying it.Enjoy the circle of pizza with your friendcircle.",
